      ...
      <div className="grid2">
        <div className="card">
          <div className="cardBody">
            <div className="sectionTitle">上传文档</div>
            <div className="note" style={{ marginTop: 6 }}>支持 PDF / DOCX / TXT / Markdown，后台自动分片与向量化。</div>
            <div className="rowWrap" style={{marginTop:12}}>
              <button className="btn btnPrimary" onClick={() => nav("/upload")}>前往上传</button>
              <span className="pill">{user ? `当前用户：${user.email || user.username}` : "未登录"}</span>
            </div>
          </div>
        </div>
        <div className="card">
          <div className="cardBody">
            <div className="sectionTitle">智能问答</div>
            <div className="note" style={{ marginTop: 6 }}>基于你上传的文档进行检索后回答，支持多会话。</div>
            <div className="rowWrap" style={{marginTop:12}}>
